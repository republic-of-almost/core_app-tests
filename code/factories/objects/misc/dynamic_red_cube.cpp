...
Core::Entity
dynamic_red_cube_create(Core::World &world, const Core::Transform *override_transform)
{
  // Create Entity
  ...
  // Setup entity
  {
    entity.set_name("Dynamic_red_cube");
...
//    entity.set_renderer(mat_renderer);
  ...
  return entity;
} // dynamic_red_cube_create function
